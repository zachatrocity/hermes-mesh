...
- Click 'Use this template' button above or [click here](https://github.com/new?template_name=hermes-mesh&template_owner=zachatrocity)
- Clone your repo
- Run `./dev.sh`
...
### Repo
Source of truth for myself is on my [sr.ht repo](https://git.sr.ht/~zachr/hermes-mesh) but I keep this up to date for the templating in Github
